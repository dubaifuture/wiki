...
<table>
  ...
  <tbody>
    ...
    <td style="text-align: center"><img src="reportbug01.jpg"{ width=50% } alt="Report Bug Step 1"></td>
    </tr>
    <tr>
    <td style="text-align: left"><p><b>Step 2:</b></p>Choose ALIA Chatbot below the search bar.</td>
    <td style="text-align: center"><img src="reportbug02.jpg"{ width=50% } alt="Report Bug Step 2"></td>
    </tr>
    <tr>
    ...
    <td style="text-align: center"><img src="reportbug03.jpg"{ width=50% } alt="Report Bug Step 3"></td>
    </tr>
    <tr>
