...
<table>
  <thead>
    ...
    <tr>
    <td style="text-align: left"><p><b>Step 3:</b></p>Remove one of the devices listed below "DEVICES".<b>Note: your current device is the one at the beginning of the row, so do not log yourself out by removing your current active device.</b></td>
